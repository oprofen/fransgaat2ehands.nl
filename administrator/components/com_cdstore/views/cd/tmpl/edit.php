...
<script type="text/javascript">
    Joomla.submitbutton = function (task) {
        if (task == 'cd.cancel' || document.formvalidator.isValid(document.id('cd-form'))) {
            Joomla.submitform(task, document.getElementById('cd-form'));
        }
    }
</script>

<form action="<?php echo JRoute::_('index.php?option=com_cdstore&id=' . (int)$this->item->id); ?>" method="post"
      name="adminForm" id="cd-form" class="form-validate">
    ...
    <div class="form-horizontal main-product">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'Tab_1', JText::_('COM_CDSTORE_FIELDSET_TAB_1', true), true); ?>
        <div class="row-fluid">
            <div class="span4">
                <fieldset>
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'Tab_2', JText::_('COM_CDSTORE_FIELDSET_TAB_2', true), true); ?>
        <div class="row-fluid">
            <div class="span4">
                <fieldset>
    ...
    <?php echo JHtml::_('bootstrap.endTab'); ?>
        <?php if ($this->canDo->get('core.admin')) : ?>
            <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'permissions', JText::_('COM_CDSTORE_FIELDSET_RULES', true)); ?>
