...
<form action="<?php echo JRoute::_('index.php?option=com_dvdstore&id=' . (int)$this->item->id); ?>" method="post"
      name="adminForm" id="dvd-form" class="form-validate">
    ...
    <div class="form-horizontal main-product">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'Tab_1', JText::_('COM_DVDSTORE_FIELDSET_TAB_1', true), true); ?>
        <div class="row-fluid">
            <div class="span4">
                <fieldset>
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'Tab_2', JText::_('COM_DVDSTORE_FIELDSET_TAB_2', true), true); ?>
        <div class="row-fluid">
            <div class="span4">
                <fieldset>
    ...
    <?php echo JHtml::_('bootstrap.endTab'); ?>
        <?php if ($this->canDo->get('core.admin')) : ?>
            <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'permissions', JText::_('COM_DVDSTORE_FIELDSET_RULES', true)); ?>
